...
class PortfolioController extends BaseController {
    ...
    public function vistaListado() {
        ...
        return View::make('portfolio_simple.lista', $this->array_view);
    }
    ...
    public function mostrarInfo($url) {
        ...
        return View::make('portfolio_simple.' . $this->project_name . '-ver', $this->array_view);
    }
    ...
    public function vistaAgregar($seccion_id) {
        ...
        return View::make('portfolio_simple.agregar', $this->array_view);
    }
    ...
    public function agregar() {
        ...
        if ($respuesta['error'] == true) {
            ...
            return Redirect::to('admin/portfolio_simple/agregar/' . $seccion->id)->with('mensaje', $respuesta['mensaje']); //->with('ancla', $ancla);
            //return Redirect::to('admin/producto')->withErrors($respuesta['mensaje'])->withInput();
        } else {
    ...
    public function vistaEditar($id, $next) {
        ...
        if ($portfolio) {
            ...
            return View::make('portfolio_simple.editar', $this->array_view);
        } else {
    ...
    public function editar() {
         ...
         */
        if ($respuesta['error'] == true) {
            return Redirect::to('admin/portfolio_simple/editar/' . Input::get('portfolio_id'))->with('mensaje', $respuesta['mensaje']);
            //return Redirect::to('admin/producto')->withErrors($respuesta['mensaje'])->withInput();
        } else {
    ...
    public function destacar() {
         ...
         */
        if ($respuesta['error'] == true) {
            return Redirect::to('admin/portfolio_simple')->withErrors($respuesta['mensaje'])->withInput();
        } else {
            if (Input::get('continue') == "home") {
                return Redirect::to('/')->with('mensaje', $respuesta['mensaje']);
            } else {
